...
function play(userChoice) {
    const cpuChoice = getCpuChoice();
    // const union = userChoice + cpuChoice;
    if (userChoice + cpuChoice == 'rockscissors' || userChoice + cpuChoice == 'paperrock' || userChoice + cpuChoice == 'scissorspaper') {
        win(userChoice, cpuChoice);
    } else if (userChoice + cpuChoice == 'rockpaper' || userChoice + cpuChoice == 'paperscissors' || userChoice + cpuChoice == 'scissorsrock') {
        lose(userChoice, cpuChoice);
    } else {
        draw(userChoice, cpuChoice);
    }
